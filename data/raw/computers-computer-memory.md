...
source: "https://simple.wikipedia.org/wiki/Computer_memory"
...
A byte of memory is used to store a code to represent a character such as a number, a letter or a symbol. Eight bits can store 256 different codes. This was thought enough and a byte became fixed at eight bits. 
This allows the ten decimal digits, 26 lower-case letters, 26 upper-case letters and many symbols. 
Early computers used six bits to a byte. This gave them 64 different codes. These computers did not have lower-case letters. 
