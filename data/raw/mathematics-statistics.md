---
title: "Statistics"
source: "https://simple.wikipedia.org/wiki/Statistics"
...
Starting in the 16th century, mathematicians such as Gerolamo Cardano developed the probability theory; this led statistics closer to being a science. Since then, people have collected and studied statistics on many things. Trees, starfish, stars, rocks, words, almost anything that can be counted has been a subject of statistics.
...
Mean
The formula for the commonly used mean (the so-called "arithmetic mean") is
...
Where 
 ...
 is the population size (see also Sigma Notation).
...
The standard deviation of a sample is generally different from the standard deviation of its originating population . Because of that, we write 
 ...
 for population standard deviation, and 
