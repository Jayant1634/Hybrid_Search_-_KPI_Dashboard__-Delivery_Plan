---
title: "Camera"
source: "https://simple.wikipedia.org/wiki/Camera"
...
A camera that takes one picture at a time is sometimes called a still camera. A camera that can take pictures that seem to move is called a movie camera. If it can take videos it is called a video camera or a camcorder. The majority of cameras are on mobile phones.
...
Moving pictures
A ciné camera or movie camera takes a rapid sequence of photographs on image sensor or strips of photographic film. Unlike a still camera, the ciné camera takes a series of images, each one is called a "frame". The frames are later played back in a ciné projector at a specific speed, called the "frame rate" (number of frames per second). While viewing, the human visual system merges the separate pictures to create the illusion of motion. The first ciné camera was built around 1888. By 1890 several types were being made. The standard film size for ciné cameras was quickly established as 35mm film. This remained in use until the transition to digital cinematography.
