---
title: "Electricity"
source: "https://simple.wikipedia.org/wiki/Electricity"
license: "CC BY-SA 4.0"
topic: "energy"
fetched: "2026-09-03"
---

Electricity is the presence and flow of electric current. Using electricity, we can transfer energy in ways that make machines do work. Its best-known form is the flow of electrons through conductors such as copper wires.
...
Switch:the switch is a device that aid in the flow of electriicity.When the switch  is turned on, electrical current flows and when its turned off the electrical current stops flowing. The switch can be small for domestic purposes and large for industrial purpose for the various substations.
