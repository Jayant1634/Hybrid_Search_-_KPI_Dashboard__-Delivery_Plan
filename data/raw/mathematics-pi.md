...
pi is defined as the ratio of a circle's circumference 
...
Pi is often written as "π". It is also an irrational number, meaning it cannot be written as a fraction 
    ...
    {\displaystyle {\bigg (}{\frac {a}{b}}{\bigg )}}
...
, where 
 ...
 are integers (whole numbers). This basically means that the digits of pi that are to the right of the decimal go forever—without repeating in a pattern, and that it is impossible to write the exact value of pi as a number. Pi can only be approximated, or measured to a value that is close enough for practical purposes.
A value close to pi is 3.14. A common fraction approximation of pi is 
...
History
Mathematicians have known about pi for thousands of years, because they have been working with circles for the same amount of time. Civilizations as old as the Babylonians have been able to approximate pi to many digits, such as the fraction 
...
. Most historians believe that ancient Egyptians had no concept of pi, and that the correspondence is a coincidence.
...
Pi in real life
There are different ways to calculate many digits of pi. This is of limited use though.
Pi can sometimes be used to work out the area or the circumference of any circle. To find the circumference of a circle, use the formula 
 ...
 (Radius). To find the area of a circle, use the formula 
 ...
 (radius squared). This formula is sometimes written as 
...
People generally celebrate March 14 as Pi Day, because March 14 is also written as "3/14", which represents the first three numbers 3.14 in the approximation of pi. Pi Day was started in 1988 by physicist Larry Shaw at the San Francisco Exploratorium. On March 11, 2009, almost 21 years later, the U.S. House of Representatives passed a resolution proclaiming March 14 to be celebrated as National Pi Day every year.
People have contests to see who can memorize the most digits of pi, and records are kept by Guinness World Records. The current world record was set by Rajveer Meena in 2015.
